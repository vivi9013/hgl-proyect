@extends('layouts.app')
@section('title', 'Seguimiento de Servicios – Soporte Técnico')
@section('content')

<div class="container-fluid py-4" id="modulo-seguimiento-servicio">

    {{-- ─── Cabecera ─────────────────────────────────────────────────────────── --}}
    <div class="modulo-header">
        <div>
            <h1 class="h3 mb-0 fw-bold">
                <i class="fa fa-list-ul me-2"></i>Mis Servicios Activos
            </h1>
            <p class="text-muted mb-0 small">Servicios pendientes de liberación</p>
        </div>
    ...
    <div class="filtros-panel">
        <x-filtro-buscar
            ...
            placeholder="Folio, descripción, área..."
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-0">
            <div id="contenedor-tabla">
                @include('soporte_tecnico.solicitar_servicio.partials.tabla_pendientes', ['servicios' => $servicios])
            </div>
