...
<div class="container-fluid py-4">
    ...
    <div class="d-flex gap-2 mb-2 flex-wrap">
        ...
        <a href="{{ route('pedidos_recibidos.aceptados') }}" class="btn btn-sm btn-outline-dark bg-white py-2 px-3 fw-bold shadow-sm" style="border: 1.5px solid #000; border-radius: 8px;">
            <i class="fa fa-check-circle me-1 text-dark"></i>Aceptados
        </a>
        <a href="{{ route('pedidos_recibidos.cancelados') }}" class="btn btn-sm btn-primary py-2 px-3 fw-bold shadow-sm" style="border: 1.5px solid #000; border-radius: 8px;">
    ...
    <div class="row mb-4 align-items-end g-3">
        <div class="col-12">
            <form method="GET" action="{{ route('pedidos_recibidos.cancelados') }}" id="formBuscar">
                <div class="row g-2 align-items-end">
                    <div class="col-12 col-md-6 position-relative">
                        ...
                        <div class="input-group" style="border: 1.5px solid #000; border-radius: 10px; overflow: hidden;">
                            ...
                            @if($buscar)
                                <a href="{{ route('pedidos_recibidos.cancelados') }}" class="input-group-text bg-light border-0 text-decoration-none" title="Limpiar">
                                    <i class="fa fa-times text-danger"></i>
                                </a>
                            @endif
                            <button class="input-group-text bg-light border-0" type="submit"><i class="fa fa-search text-dark"></i></button>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            @if($buscar || $fechaInit || $fechaFin)
                                <a href="{{ route('pedidos_recibidos.cancelados') }}" class="btn btn-outline-secondary" title="Limpiar Filtros">
            ...
            <div class="card shadow-sm border-0 bg-transparent">
                <div class="card-header bg-white border-0 pt-4 px-0 pb-2 d-flex align-items-center gap-3">
                    ...
                    <span class="rounded-pill px-3 py-1 fw-bold" style="background-color: #e9ecef; font-size: 0.78rem;">
                        <span style="color: #000;">{{ $pedidos->total() }}</span>
                            ...
                            <tbody>
                                @forelse ($pedidos as $pedido)
                                    <tr>
                                        ...
                                        <td>
                                            <span style="font-family: Arial, sans-serif; font-size: 0.82rem; font-weight: 600; color: #b91c1c; background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 6px; padding: 3px 10px; display: inline-block;">
