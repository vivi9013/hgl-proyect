...
<div class="container-fluid py-4">
    ...
    <div class="d-flex gap-2 mb-2 flex-wrap">
        <a href="{{ route('pedidos_recibidos.index') }}" class="btn btn-sm btn-primary py-2 px-3 fw-bold shadow-sm" style="border: 1.5px solid #000; border-radius: 8px;">
    ...
    <div class="row mb-4 align-items-end g-3">
        <div class="col-12">
            <form method="GET" action="{{ route('pedidos_recibidos.index') }}" id="formBuscar">
                <div class="row g-2 align-items-end">
                    <div class="col-12 col-md-6 position-relative">
                        ...
                        <div class="input-group" style="border: 1.5px solid #000; border-radius: 10px; overflow: hidden;">
                            ...
                            @if($buscar)
                                <a href="{{ route('pedidos_recibidos.index') }}" class="input-group-text bg-light border-0 text-decoration-none" title="Limpiar">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            @if($buscar || $fechaInit || $fechaFin)
                                <a href="{{ route('pedidos_recibidos.index') }}" class="btn btn-outline-secondary" title="Limpiar Filtros">
