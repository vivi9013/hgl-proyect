            ...
            <div class="card border-0 shadow-sm p-4 rounded-3 bg-white h-100 d-flex justify-content-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Módulo para registrar, editar y controlar las áreas físicas de almacenamiento</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-sm p-4 rounded-3 bg-white h-100 justify-content-center">
                <div class="d-flex flex-wrap gap-2 justify-content-md-end align-items-center">
                    <a href="{{ route('areas_almacen.imprimir') }}"
                       target="_blank"
        ...
        <div class="col-xs-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa fa-plus-circle me-2"></i>Registrar nueva área de almacén</h5>
                ...
                <div class="collapse show" id="collapseAlta">
                    <form method="POST" action="{{ route('areas_almacen.store') }}" novalidate>
                        @csrf
                        <div class="card-body">
                            <div class="row">
        ...
        <div class="col-xs-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa fa-list me-2"></i>Lista de áreas de almacén</h5>
