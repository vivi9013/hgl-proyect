...
@section('title', 'Gráficas - Especialidades RX')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h1 class="h3 mb-0 fw-bold">
                <i class="fa fa-bar-chart text-primary me-2"></i>Análisis y Gráficas de Especialidades
            </h1>
            <p class="text-muted mb-0">Visualiza estadísticas en tiempo real de estudios radiológicos por especialidad médica</p>
        </div>
    </div>
    ...
    <div class="row g-4">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
                    <h5 class="card-title mb-0 fw-bold text-dark">
                        <i class="fa fa-bar-chart text-secondary me-2"></i>Estudios Realizados
                    </h5>
                    <p class="text-muted small mb-0">Total de estudios radiológicos agrupados por especialidad médica</p>
                </div>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
                    <h5 class="card-title mb-0 fw-bold text-dark">
                        <i class="fa fa-pie-chart text-secondary me-2"></i>Distribución General
                    </h5>
                    <p class="text-muted small mb-0">Porcentaje de participación de cada especialidad en el total de estudios</p>
                </div>
