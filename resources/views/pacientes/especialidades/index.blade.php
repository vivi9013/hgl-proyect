...
@section('title', 'Especialidades RX - Estudios Radiológicos')

@section('content')
<div class="container-fluid py-4" id="modulo-rx-especialidades">
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h1 class="h3 mb-0 fw-bold">
                <i class="fa fa-university text-primary me-2"></i>Especialidad RX
            </h1>
            <p class="text-muted mb-0">Catálogo de especialidades médicas utilizadas en los estudios de radiología.</p>
        </div>
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            {{-- Botón Reportes --}}
            <a href="{{ route('rx_especialidades.reportes') }}"
            ...
            {{-- Botón Gráficas --}}
            <a href="{{ route('rx_especialidades.graficas') }}"
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 fw-bold text-dark">
                        <i class="fa fa-pencil text-secondary me-2"></i>Registra una nueva Especialidad
                    </h5>
                </div>
                <div class="card-body px-4 pb-4 pt-2">
                    <form id="frmAltaEspecialidad" novalidate>
                        <div class="row g-3">
                            <div class="col-12 col-md-8 col-lg-9">
                                <label for="nombreEsp" class="form-label small fw-bold mb-1 text-dark">Nombre de la Especialidad *</label>
                                <input type="text" id="nombreEsp" name="nombre" class="form-control bg-light py-2" placeholder="Coloque el nombre de la Especialidad" required>
                            ...
                            <div class="col-12 col-md-4 col-lg-3">
                                ...
                                <input type="text" id="abre" name="abreviatura" class="form-control bg-light py-2 font-monospace text-uppercase" placeholder="SOLO TRES LETRAS" maxlength="3" required style="letter-spacing: 0.1em;">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2 d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="fa fa-list text-secondary me-2"></i>Lista de Especialidades
                        </h5>
                    ...
                    <div class="input-group" style="width: 280px; border: 1.5px solid #000; border-radius: 10px; overflow: hidden;">
                        <input type="text" id="buscar-especialidad" class="form-control bg-light border-0 py-2" placeholder="Buscar por nombre o abreviatura..." style="font-size: 0.9rem; box-shadow: none;">
                ...
                <div class="card-body p-0 mt-2">
                    <div class="table-responsive">
                        <table id="tablaEspecialidades" class="table table-hover align-middle mb-0">
                ...
                <div class="card-footer bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center border-top mt-2">
                    ...
                    <div id="paginador-especialidades">
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-bottom px-4 py-3 bg-light">
                <h5 class="modal-title fw-bold text-dark mb-0" id="modalEditarLabel">
                    <i class="fa fa-edit text-dark me-2"></i>Editar Información de Especialidad
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <form id="frmEditarEspecialidad" novalidate>
                <div class="modal-body p-4">
                    <input type="hidden" id="idRegistro">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="EnombreEsp" class="form-label small fw-bold mb-1 text-dark">Nombre de la Especialidad *</label>
                            <input type="text" id="EnombreEsp" name="nombre" class="form-control bg-light py-2" placeholder="Coloque el nombre de la Especialidad" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="Eabre" name="abreviatura" class="form-control bg-light py-2 font-monospace text-uppercase" placeholder="SOLO TRES LETRAS" maxlength="3" required style="letter-spacing: 0.1em;">
...
@push('scripts')
    @vite(['resources/js/pacientes/especialidades/especialidades.js'])
@endpush
