            ...
            <div class="col-xs-12">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        ...
                        <div class="box-body">
                          <p>Permite generar un reporte en gráfica de pastel de la cantidad de archivos que se encuentran en cada categoría dentro del sistema.</p>
                        </div><!-- /.box-body -->

                        <div class="box-footer">
                          <a  href="graficaPastel.php" class="btn btn-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-eye"></i> Ver Gráfica</a>
                        </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        <div class="box-header with-border">
                          <h3 class="box-title">Archivos</h3>
                          <span class="label label-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-bar-chart fa-2x"></i></span>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          <p>Permite generar un reporte en gráfica de barras de la cantidad de archivos que se encuentran en cada categoría dentro del sistema.</p>
                        </div><!-- /.box-body -->

                        <div class="box-footer">
                          <a  href="graficaBarra.php" class="btn btn-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-eye"></i> Ver Gráfica</a>
                        </div>
