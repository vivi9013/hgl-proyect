...
@section('title', 'Tipo de Mobiliario - Hospital General')
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-crosshairs text-primary me-2"></i>Tipo de Mobiliario
            </h1>
            <p class="text-muted mb-0">Catálogo de categorías para la clasificación del mobiliario institucional</p>
        </div>
    </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-sm p-4 rounded-3 bg-white h-100 d-flex justify-content-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h6 class="fw-bold mb-1 text-dark">Panel de Control de Tipo de Mobiliario</h6>
                        <p class="text-muted small mb-0">Administración del catálogo de tipos para la clasificación del mobiliario del hospital. Permite registrar, editar, activar/desactivar y exportar reportes.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-sm p-4 rounded-3 bg-white h-100 justify-content-center">
                <div class="d-flex flex-wrap gap-2 justify-content-md-end align-items-center">
                    ...
                    {{-- Gráficas --}}
                    <a href="{{ route('tipo_mobiliario.graficas') }}" class="btn btn-outline-secondary px-3 py-2 rounded-pill shadow-sm w-100 w-sm-auto text-nowrap">
                        <i class="fa fa-pie-chart me-2 text-primary"></i> Gráficas
                    </a>

                    {{-- Reportes --}}
                    <a href="{{ route('tipo_mobiliario.reportes') }}" class="btn btn-outline-secondary px-3 py-2 rounded-pill shadow-sm w-100 w-sm-auto text-nowrap">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <h5 class="card-title mb-0 fw-bold text-dark">
                                <i class="fa fa-list-ul text-secondary me-2"></i>Lista de Tipos de Mobiliario
                            </h5>
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-2">
                            ...
                            <div class="input-group" style="min-width: 240px; border: 1.5px solid #000; border-radius: 10px; overflow: hidden;">
                                <input type="search" id="global-search" class="form-control bg-light border-0" placeholder="Buscar tipo..." style="font-size: 0.85rem; box-shadow: none;" value="{{ $buscar }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody id="tbodyArchivos">
                                {{-- Carga inicial --}}
                                @include('admin_mobiliario.tipo_mobiliario.partials.tabla')
                            </tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="card-footer bg-white border-0 py-3 d-flex justify-content-between align-items-center border-top">
                    ...
                    <nav aria-label="Paginacion de tipos de mobiliario">
    ...
    <!-- Modal Registrar Nuevo Tipo de Mobiliario -->
            ...
            <div class="modal-content border-0 shadow-lg rounded-3" style="background-color: #ffffff; border: 2px solid #000000 !important;">
                <div class="modal-header bg-white border-0 pt-4 px-4 pb-0">
                    <h5 class="modal-title fw-bold text-dark" id="modalRegistrarTipoLabel">
                        <i class="fa fa-plus-circle text-dark me-2"></i>Registrar nuevo tipo de mobiliario
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar" style="filter: brightness(0);"></button>
                </div>
                <form id="formRegistrarTipo" action="{{ route('tipo_mobiliario.store') }}" method="POST" autocomplete="off">
                    @csrf
...
@vite(['resources/css/tipo_mobiliario/tipo_mobiliario.css', 'resources/js/tipo_mobiliario/tipo_mobiliario.js'])
@endsection
