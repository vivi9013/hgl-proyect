...
@forelse($tipos as $t)
    <tr class="{{ $t->activo == 0 ? 'text-muted opacity-75' : '' }}">
        ...
        <td class="text-center">
            <a href="{{ route('tipo_mobiliario.edit', $t->id) }}"
...
@empty
    <tr>
        <td colspan="6" class="text-center py-4 text-muted">
            <i class="fa fa-crosshairs fs-3 mb-2 d-block"></i> No hay tipos de mobiliario registrados
        </td>
    </tr>
@endforelse
