...
@section('title', 'Gráficas de Impresoras - Hospital General')
...
<div class="container-fluid py-4" id="modulo-impresoras">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-pie-chart text-primary me-2"></i>Módulo Estadístico de Impresoras
            </h1>
            <p class="text-muted mb-0">Visualización analítica de la cantidad de impresoras agrupadas por tecnología y tipo</p>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-3 rounded-3 bg-white">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <a href="{{ route('impresoras.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                        <i class="fa fa-arrow-left me-1"></i> Volver al Catálogo de Impresoras
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
        ...
        {{-- Gráfica de Pastel (Donut) - Por Tecnología --}}
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-pie-chart text-warning me-2"></i>Distribución por Tecnología
                    </h5>
                ...
                <div class="card-body p-4 d-flex align-items-center justify-content-center chart-container-donut">
                    <div class="position-relative chart-donut-wrapper">
                        <canvas id="pastelChart" data-json="{{ json_encode($porTecnologia) }}"></canvas>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-bar-chart text-success me-2"></i>Impresoras por Tipo de Dispositivo
                    </h5>
