...
@section('title', 'Reportes - Almacén de Subáreas')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-0 fw-bold text-dark">
                <i class="bi bi-file-earmark-pdf me-2 text-primary"></i>Configuración de Reportes de Inventario por Subárea
            </h2>
            <small class="text-muted">Generación e impresión de reportes oficiales de stock local y fondo fijo</small>
        </div>
        ...
        <div class="col-12 col-md-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('almacen_subareas.imprimir') }}" method="GET" target="_blank">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="status" class="form-label fw-bold small">Estatus del Almacén</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="buscar" name="buscar" placeholder="Palabra clave en áreas o subáreas...">
                        </div>
