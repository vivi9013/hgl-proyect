...
<div style="font-family: Arial, sans-serif; font-size: 11px; color: #333;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; border: 1px solid #ccc;">
        <tr style="background-color: #f5f5f5;">
            <td style="padding: 6px; font-weight: bold; border-right: 1px solid #ccc; width: 18%;">FOLIO PEDIDO:</td>
            <td style="padding: 6px; font-weight: bold; color: #0d6efd; border-right: 1px solid #ccc; width: 32%; font-size: 13px;">
                #{{ $pedido->id_pedido }}
            </td>
            <td style="padding: 6px; font-weight: bold; border-right: 1px solid #ccc; width: 18%;">FECHA / HORA:</td>
    ...
    <h3 style="font-size: 12px; margin-bottom: 5px; border-bottom: 2px solid #333; padding-bottom: 3px;">DESGLOSE DE INSUMOS SOLICITADOS POR DÉFICIT DE FONDO FIJO</h3>
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 25px;" border="1" cellpadding="5" cellspacing="0">
        <thead>
            <tr style="background-color: #e9ecef; font-weight: bold; text-align: center;">
                ...
                <th style="width: 11%;">STOCK PREVIO</th>
                <th style="width: 12%;">FONDO FIJO</th>
        ...
        <tbody>
            @forelse($pedido->detalles as $index => $det)
                <tr>
                    ...
                    <td style="text-align: center; color: #6c757d;">{{ $det->existencia }}</td>
                    <td style="text-align: center; color: #0d6efd;">{{ $det->fondo_fijo }}</td>
                    <td style="text-align: center; font-weight: bold; color: #d9534f;">{{ $det->cantidad }}</td>
                </tr>
            @empty
                <tr>
        ...
        <tr>
            <td style="width: 33%; text-align: center; vertical-align: bottom;">
                <div style="border-top: 1px solid #000; width: 85%; margin: 0 auto; padding-top: 5px;">
                    <strong>SOLICITÓ (ÁREA)</strong><br>
                    <span style="font-size: 10px;">Firma del Encargado</span>
                </div>
            </td>
            <td style="width: 33%; text-align: center; vertical-align: bottom;">
                <div style="border-top: 1px solid #000; width: 85%; margin: 0 auto; padding-top: 5px;">
            ...
            <td style="width: 33%; text-align: center; vertical-align: bottom;">
                <div style="border-top: 1px solid #000; width: 85%; margin: 0 auto; padding-top: 5px;">
                    ...
                    <span style="font-size: 10px;">Personal Solicitante</span>
                </div>
            </td>
        </tr>
    </table>
