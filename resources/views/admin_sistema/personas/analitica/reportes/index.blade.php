...
<div class="container-fluid py-4">
    ...
    <div class="row g-4">
        ...
        {{-- Tarjeta especial: Reporte con Filtros — exclusivo del módulo de Personas --}}
        <div class="col-12 col-md-6 col-lg-7">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <form id="formReporteFiltrado" action="{{ route('personas.imprimir') }}" method="GET" target="_blank" class="h-100 d-flex flex-column justify-content-between">
                    <div>
