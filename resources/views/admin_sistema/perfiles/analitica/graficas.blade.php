...
@section('title', 'Gráficas de Perfiles - Hospital General')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <div>
            ...
            <p class="text-muted mb-0">Visualización analítica de cantidad de módulos activos asignados a cada perfil</p>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-3 rounded-3 bg-white">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <a href="{{ route('perfiles.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                        <i class="fa fa-arrow-left me-1"></i> Volver al Catálogo de Perfiles
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-pie-chart text-warning me-2"></i>Distribución de Módulos por Perfil
                    </h5>
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-bar-chart text-success me-2"></i>Cantidad de Módulos por Perfil
                    </h5>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const labels = {!! json_encode($dataGrafica->pluck('nombre')) !!};
        ...
        new Chart(ctxBar, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: data,
                    backgroundColor: '{{ session('s_colGr', '#2980b9') }}', // Color de tema de la sesión
                    borderRadius: 0,
                    maxBarThickness: 40
                }]
            },
