...
@section('title', 'Gráficas de Usuarios - Hospital General de Linares')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-pie-chart text-primary me-2"></i>Módulo Estadístico — Usuarios
            </h1>
            <p class="text-muted mb-0">Distribución analítica de usuarios en base al género del trabajador</p>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm p-3 rounded-3 bg-white">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <a href="{{ route('usuarios.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                        <i class="fa fa-arrow-left me-1"></i> Volver al Catálogo de Usuarios
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4 justify-content-center">
        ...
        <div class="col-6 col-md-4">
            <div class="card border-0 shadow-sm rounded-3 bg-white text-center p-3">
                ...
                <small class="text-muted fw-semibold">Usuarios Inactivos</small>
            </div>
        </div>
    </div>
