...
@section('title', 'Métrica de Barras - Hospital General')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Barras</li>
                </ol>
            </nav>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-bar-chart text-primary me-2"></i>Comparativa de Volúmenes
            </h1>
            <p class="text-muted mb-0">Volumen de módulos contenidos en cada categoría del sistema</p>
        </div> 
    </div>

    {{-- Contenedor del Gráfico de Barras Plano --}}
    <div class="row g-4 justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm rounded-3 bg-white">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0 fw-bold text-dark">
                        <i class="fa fa-adjust text-secondary me-2"></i>Módulos por Categoría
                    </h5>
                ...
                <div class="card-body p-4 d-flex justify-content-center">
                    <div class="position-relative w-100 style-chart-container" style="height: 380px; max-width: 700px;">
                        <canvas id="canvasGraficaBarras"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
@vite(['resources/css/categoria_modulos/categoria_graficas.css', 'resources/js/categoria_modulos/grafica_barras.js'])
@endsection