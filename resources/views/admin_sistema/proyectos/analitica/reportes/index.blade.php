        ...
        <div class="col-12 col-md-6 col-lg-5">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100 d-flex flex-column justify-content-between">
                ...
                <div>
                    <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="fa fa-list-alt text-secondary me-2"></i>Lista Completa de Proyectos
                        </h5>
                    ...
                    <div class="card-body px-4 py-3">
                        <p class="text-muted small mb-0" style="line-height: 1.6;">
                            Imprime o genera el documento oficial con la lista completa de los proyectos registrados en el sistema. El listado se genera preordenado alfabéticamente por el nombre del proyecto para una auditoría visual óptima.
                        </p>
                    </div>
                </div>
                ...
                <div class="card-footer bg-light border-0 py-3 px-4 rounded-bottom-3 d-flex justify-content-end border-top">
                    <a href="{{ route('proyectos.imprimir') }}" target="_blank" class="btn btn-primary py-2 px-4 rounded-pill shadow-sm">
