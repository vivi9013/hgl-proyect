...
<head>
    ...
    <title>Reporte - Categoría de Archivos</title>
...
<body onload="window.print()">
    <div class="container py-5">
        ...
        <h4 class="fw-bold mb-4 text-center text-dark">LISTA COMPLETA DE LA CATEGORIZACIÓN DE ARCHIVOS</h4>
        ...
        <table class="table table-bordered table-striped align-middle">
            <thead>
                <tr>
                    ...
                    <th>Categoría</th>
                    <th style="width: 250px;" class="text-center">Cantidad de archivos</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($categorias as $index => $cat)
                    <tr>
                        ...
                        <td class="text-center"><span class="badge-count">{{ $cat->archivos_count }}</span></td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="text-center py-4">No se encontraron categorías activas con formatos asociados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="footer-info d-flex justify-content-between align-items-center">
            <span>Reporte de categorización generado automáticamente por el sistema de estadías.</span>
