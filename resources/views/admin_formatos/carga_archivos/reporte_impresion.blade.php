...
<head>
    ...
    <title>Reporte - Archivos por Categoría</title>
...
<body onload="window.print()">
    <div class="container py-5">
        ...
        <h4 class="fw-bold mb-4 text-center text-dark text-uppercase">LISTA COMPLETA DE ARCHIVOS DE: {{ $categoria->categoria }}</h4>
        ...
        <table class="table table-bordered table-striped align-middle">
            <thead>
                <tr>
                    ...
                    <th>Descripción</th>
                    <th style="width: 150px;" class="text-center">Fecha Registro</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($archivos as $index => $archivo)
                    <tr>
                        ...
                        <td class="text-center">{{ \Carbon\Carbon::parse($archivo->fecha_registro)->format('d/m/Y') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-4">No se encontraron archivos activos asociados a esta categoría.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="footer-info d-flex justify-content-between align-items-center">
            <span>Reporte de archivos generado automáticamente por el sistema de estadías.</span>
