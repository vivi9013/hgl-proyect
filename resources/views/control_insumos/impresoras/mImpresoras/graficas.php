            ...
            <div class="col-xs-12">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        <div class="box-header with-border">
                          <h3 class="box-title">Por Computadora</h3>
                          <span class="label label-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-pie-chart fa-2x"></i></span>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          <p>Permite generar un reporte en grafica circular de las computadoras que tienen acceso a internet.</p>
                        </div><!-- /.box-body -->

                        <div class="box-footer">
                          <a  href="grafoPieCarrera.php" class="btn btn-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-eye"></i> Ver Grafica</a>
                        </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        ...
                        <div class="box-body">
                          <p>Permite generar un reporte en grafica de barras de las computadoras que tienen accesso a internet.</p>
                        </div><!-- /.box-body -->

                        <div class="box-footer">
                          <a  href="grafoBarCarrera.php" class="btn btn-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-eye"></i> Ver Grafica</a>
                        </div>
