                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        <div class="box-header with-border">
                          <h3 class="box-title">Lista completa de las Impresoras</h3>
                          <span class="label label-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-file-pdf-o fa-2x"></i></span>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          <p>Imprime una lista completa de las impresoras ingresadas en el sistema , ordenado de manera descendente.</p>
                        </div><!-- /.box-body -->

                        <div class="box-footer">
                          <a target="_blank" href="reportes/lista_completa.php" class="btn btn-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-print"></i> Imprimir Reporte</a>
                        </div>
