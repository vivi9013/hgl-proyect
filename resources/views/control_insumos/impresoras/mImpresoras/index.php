                ...
                n-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4 <col-lg-34></col-lg-4>">
                          <div class="form-group">
                            ...
                            <select name="tipo" class="form-control select2" id="tipo" style="width: 100%;">
                              <option selected="selected" value="Lasser">Lasser</option>
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4 <col-lg-4></col-lg-4>">
                        <div class="form-group">
                            ...
                            <input type="text" name="serie" class="form-control" id="serie" placeholder="Coloque el numero de serie de la impresora" autofocus required>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 <col-lg-3></col-lg-3>">
                        <div class="form-group">
                          ...
                          <input type="text" name="modelo" class="form-control" id="modelo" placeholder="Coloque el modelo de la impresora">    
                        </div><!-- /.form-group -->
                      </div>
                       ...
                       <div class="col-xs-12 col-sm-6 col-md-3 <col-lg-3></col-lg-3>">
	                      <div class="form-group">
	                          ...
	                          <input type="text" name="marca" class="form-control" id="marca" placeholder="Coloca la marca de la impresora" autofocus required>
	                      </div>
	                    </div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 <col-lg-3></col-lg-3>">
                          <div class="form-group">
                            ...
                            <input type="text" name="descripcion" class="form-control" id="descripcion" placeholder="Coloque una descripcion de la impresora" autofocus required>
                        </div>
                      </div>
	                    ...
	                    <div class="col-xs-12 col-sm-6 col-md-3 <col-lg-3></col-lg-3>">
	                      <div class="form-group">
                            ...
                            <input type="text" name="tecnologia" class="form-control" id="tecnologia" placeholder="Coloque la tecnologia de la impresora" autofocus required>
                        </div>
	                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 <col-lg-3></col-lg-3>">
                        <div class="form-group">
                          <label>Consumible:</label>
                           <select name="consumible" class="form-control select2" id="consumible" style="width: 100%;">
                              <option selected="selected" value="Tonner">Tonner</option>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="ip" class="form-control" id="ip" value="10.19.36." placeholder="Coloque la ip de la impresora" autofocus required>                    
                        </div>
