...
@section('title', 'Analítica de Sedes - Hospital General')

@section('content')
<div class="container-fluid py-4" id="modulo-sedes">

    {{-- Encabezado --}}
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-pie-chart text-primary me-2"></i>Módulo Estadístico de Sedes
            </h1>
            <p class="text-muted mb-0">Análisis y distribución del catálogo de sedes institucionales</p>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-3 rounded-3 bg-white">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <a href="{{ route('sedes.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-sm-4">
            <div class="card border-0 shadow-sm rounded-3 bg-white p-3 d-flex flex-row align-items-center gap-3">
                ...
                <div>
                    <h6 class="text-muted mb-0 small uppercase fw-bold">Total Sedes</h6>
    ...
    <div class="row g-4 mb-4">
        ...
        {{-- Gráfica de Barras - Top sedes por personas --}}
        <div class="col-12 col-lg-7">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-users text-info me-2"></i>Personas por Sede (Top 10)
                    </h5>
