...
@section('title', 'Editar Tipo de Trabajador - Hospital General')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-pencil-square-o text-primary me-2"></i>Editar Tipo de Trabajador
            </h1>
            <p class="text-muted mb-0">Modificar la información del tipo de trabajador seleccionado</p>
        </div>
        <a href="{{ route('tipo_trabajador.index') }}" class="btn btn-light rounded-pill shadow-sm">
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-white">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
                    <h5 class="card-title mb-0 fw-bold text-dark">
                        <i class="fa fa-edit text-secondary me-2"></i>Datos del Tipo de Trabajador
                    </h5>
                </div>

                <form action="{{ route('tipo_trabajador.update', $tipo->id) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer bg-light border-0 py-3 px-4 rounded-bottom-3 d-flex justify-content-end gap-2">
                        <a href="{{ route('tipo_trabajador.index') }}" class="btn btn-light py-2 rounded-pill shadow-sm">
...
@vite(['resources/css/tipo_trabajador/tipo_trabajador.css'])
@endsection
