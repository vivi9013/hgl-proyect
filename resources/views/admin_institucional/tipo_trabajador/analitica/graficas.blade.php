...
@section('title', 'Analítica de Tipos de Trabajador - Hospital General')

@section('content')
<div class="container-fluid py-4" id="modulo-tipo-trabajador">

    {{-- Encabezado --}}
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        <div>
            <h1 class="h3 mb-0 text-gray-800 fw-bold">
                <i class="fa fa-pie-chart text-primary me-2"></i>Módulo Estadístico de Tipos de Trabajador
            </h1>
            <p class="text-muted mb-0">Análisis y distribución del catálogo de tipos de trabajador institucional</p>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-3 rounded-3 bg-white">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <a href="{{ route('tipo_trabajador.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
    ...
    <div class="row g-4 mb-4">
        ...
        {{-- Gráfica de Barras - Top tipos por trabajadores asignados --}}
        <div class="col-12 col-lg-7">
            <div class="card border-0 shadow-sm rounded-3 bg-white h-100">
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0 text-dark">
                        <i class="fa fa-bar-chart text-success me-2"></i>Trabajadores por Tipo (Top 10)
                    </h5>
                ...
                <div class="card-body p-4 d-flex align-items-center justify-content-center" style="min-height: 320px;">
                    <div class="w-100 h-100" style="min-height: 260px; position: relative;">
                        <canvas id="barTrabajadorChart" data-json="{{ json_encode($porTrabajador) }}"></canvas>
                    </div>
                </div>
            </div>
        </div>
