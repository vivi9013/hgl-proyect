                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      ...
                      <div class="box box-<?php echo "$sColorCaja";  ?>">
                        <div class="box-header with-border">
                          <h3 class="box-title">Lista de Materias por plan de Estudio</h3>
                          <span class="label label-<?php echo "$sColorCaja";  ?> pull-right"><i class="fa fa-file-pdf-o fa-2x"></i></span>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          <p>Imprime una lista de las materias ingresadas en el sistema filtradas por el plan de esudios, ordenado por nombre de la carrera.</p>

                       <div class="col-xs-12 ">
                        <div class="form-group">
                          <label>Plan de Estudios:</label>
                          <select name="idplan" class="form-control select2" style="width: 100%;">
                            <?
                            for($i=0;$i<$num2;$i++) 
                            {
                              $id=mysql_result($combo2,$i,'id_planEstudios');
                              $tipoplan=mysql_result($combo2,$i,'nomb');
                              echo "<option value=\"$id\" >$tipoplan</option>";
                            }
                            ?> 
                          </select>
                        </div><!-- /.form-group -->
